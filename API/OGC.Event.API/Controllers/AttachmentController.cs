...
namespace OGC.Event.API.Controllers
{
    public class AttachmentController : BaseController
    {
        ...
        {
            //HttpContext.Current.Response.AppendHeader("Access-Control-Allow-Origin", 'http://valor-software.github.io');
        ...
        public IHttpActionResult Create()
        {
            ...
            if (httpRequest.Files.Count > 0)
            {
                foreach (string file in httpRequest.Files)
                {
                    ...
                    attachment.Create();
                    //var success = postedFile.InputStream.Read(bytes, 0, postedFile.ContentLength);
